...
app.factory('profileService', function(appConstants, $timeout){
	var profileService = {};
	...
	profileService.socials = [
		{name: "LinkedIn", class: "linked-in", link: "" },
		{name: "Facebook", class: "fb", link: "" },
		{name: "Google+", class: "google-plus", link: "" },
		{name: "Instagram", class: "instagram", link: "" }
	];
